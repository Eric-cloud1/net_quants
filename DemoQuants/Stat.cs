    ...
    public class checkStat
    {
        ...
        public  void TestDistributions()
        {
            ...
            for (int i = 0; i < numSamples; ++i)
                rs.Push(Normal.GetGamma(shape, scale));
            ...
            for (int i = 0; i < numSamples; ++i)
                rs.Push(Normal.GetWeibull(shape, scale));
